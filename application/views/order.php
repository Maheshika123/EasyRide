...
?>
 <!--ORDER MENU==-->
        <section id="header-slider" class="owl-carousel">
            <div class="item" style="background:url(<?=asset_url() ?>images/order/newtab.png);background-size: cover;background-position: bottom;">
                <div class="container">
                                        ...
                                        <table style="width:100%;margin-top: -19px;">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input class="form-control" type="date" name="datetime" style="width:100%;" min="2017-12-18" required></td>
                                                </tr>
                                                <tr>
