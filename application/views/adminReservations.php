                            ...
                            <table class="table" id="orderTable" style="width:100%;margin-top: 10px;">
                                            <tbody>
                                                ...
                                                <?php if (count($records)): ?>
										            ...
										            <tr>
										                <td class="text-center"><?php echo $row->res_id; ?></td>
										                ...
										                <th><a href="<?php echo base_url('Admin/completed/'.$row->res_id) ?>"><button type='submit' class='btn btn-danger'>Completed</button></th></a>
										            </tr>
