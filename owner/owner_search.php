...
<div class="sidenav"  >
  ...
  <li class="active"><a href="../owner/view_owner.php"><span class="glyphicon glyphicon-bed">Owners</span></a></li><br><br>
  </ul>
...
<nav class="navbar navbar-default navbar-fixed-top" style="margin-left: 200px; background-color: #54C04D;">
        ...
        <ul class="nav navbar-nav" style="margin-left: -170;">
            ...
            <li><a href="owner_request.php">Owner Requests</a> </li>
            <li class="active" ><a href="#">Owners</a> </li>
  ...
  <div class="container">
    <form  class="search" action="owner_search.php" method="post" style="margin: auto;max-width: 300px">
  <input type="text" name="search" placeholder="Filter drivers..">
...
include "owner_search_process.php";
