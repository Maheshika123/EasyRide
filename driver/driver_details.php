...
<nav class="navbar navbar-default navbar-fixed-top" style="margin-left: 200px; background-color: #54C04D;">
        ...
        <ul class="nav navbar-nav" style="margin-left: -170;">
            ...
            <li><a href="view_driver.php">New Drivers</a> </li>
  ...
  <div class="container">
    <form  class="search" action="driver_search.php" method="post" style="margin: auto;max-width: 300px">
...
include "driver_details_process.php";
